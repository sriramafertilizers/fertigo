...
export default function ShopSettingsPage() {
  ...
  if (isLoading) {
    return (
      <div className="bg-white p-12 rounded-2xl border border-slate-200 text-center flex flex-col items-center justify-center gap-3 max-w-4xl mx-auto font-bold text-slate-700 text-sm">
        <DashRing size={36} />
  ...
  if (!shop) {
    return (
      <div className="bg-white p-10 sm:p-14 rounded-2xl border border-slate-200 text-center space-y-4 max-w-4xl mx-auto">
        <Store className="w-12 h-12 text-slate-300 mx-auto" />
        <h2 className="text-xl font-extrabold text-slate-900">No Shop Registered Yet</h2>
        <p className="text-xs sm:text-sm text-slate-500 max-w-sm mx-auto">
          Please register your shop to manage business details and product catalog.
        </p>
        <Link
          href="/register-shop"
          className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-emerald-600 text-white font-extrabold text-xs shadow-xs touch-target"
        >
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-5xl mx-auto w-full max-w-full overflow-x-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-extrabold uppercase tracking-wider">Variants</span>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-extrabold uppercase tracking-wider">Categories</span>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-extrabold uppercase tracking-wider">Total Stock</span>
            <Store className="w-4 h-4 text-emerald-600" />
          </div>
          <div className="text-2xl font-extrabold text-emerald-800 mt-2 font-mono tabular-nums">
            {totalStockUnits}
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-semibold text-slate-900 touch-target"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-mono text-slate-900 uppercase touch-target"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-mono text-slate-900 touch-target"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm text-slate-900 touch-target"
              />
            </div>
          ...
          <div className="pt-4 border-t border-slate-200 flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs sm:text-sm shadow-xs transition-all cursor-pointer disabled:opacity-50 touch-target-lg"
            >
